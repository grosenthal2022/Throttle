...
import com.example.throttle.R;
import com.example.throttle.SQLiteHelper;
...
public class RegisterActivity extends AppCompatActivity {
    ...
    public void SQLiteTableBuild() {
        ...
        sqLiteDatabaseObj.execSQL("CREATE TABLE IF NOT EXISTS " + SQLiteHelper.TABLE_NAME + "(" + SQLiteHelper.Table_Column_ID + " PRIMARY KEY AUTOINCREMENT NOT NULL, " + SQLiteHelper.Table_Column_1_FirstName + " VARCHAR, " + SQLiteHelper.Table_Column_2_LastName + " VARCHAR, " + SQLiteHelper.Table_Column_3_Email + " VARCHAR, " + SQLiteHelper.Table_Column_4_Password + " VARCHAR);");
    ...
    public void InsertDataIntoSQLiteDatabase(){
        ...
        if(EditTextEmptyHolder == true)
        {
            ...
            SQLiteDataBaseQueryHolder = "INSERT INTO "+SQLiteHelper.TABLE_NAME+" (FirstName,LastName,Email,Password) VALUES('"+FirstNameHolder+"', '"+LastNameHolder+"', '"+EmailHolder+"', '"+PasswordHolder+"');";
